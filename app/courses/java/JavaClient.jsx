const JavaClient = () => {
  const course = {
    name: "Java Programming for Beginner to Pro",
    desc: "Learn Java from scratch to advanced, covering OOP, multithreading, collections, frameworks, and backend development.",
    ...
    highlights: [
      ...
      "JDBC, Hibernate, and Spring Boot for backend development",
      "Hands-on coding exercises and mini-projects",
      "Capstone project with real-world Java applications"
    ],
    contents: [
      ...
      "Generics, Streams & Lambda Expressions",
