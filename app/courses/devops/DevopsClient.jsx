const DevopsClient = () => {
  const course = {
    ...
    desc: "Learn DevOps practices with CI/CD, containerization, orchestration, and cloud deployment. Build scalable apps on AWS, Azure, and GCP.",
    ...
    contents: [
      ...
      "Security in DevOps",
      "Final Capstone Project (Deploying Full Stack App)"
    ]
  };
