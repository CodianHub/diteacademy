const JavaScriptClient = () => {
  const course = {
    name: "Learn JavaScript Basic to Advance",
    desc: "Master JavaScript from basics to advanced concepts. Learn how to build interactive, dynamic, and scalable applications.",
    ...
    highlights: [
      ...
      "ES6+ modern features",
      "Hands-on projects with Vanilla JS"
    ],
    contents: [
      ...
      "JavaScript in Browser (BOM, LocalStorage, Cookies)",
      "OOP in JavaScript",
      "Fetch API & AJAX",
      "Modules & Bundlers (Webpack, Vite, Parcel basics)",
      "Capstone Project in Vanilla JS"
    ]
  };
  ...
  return (
    <div className="pt-30 pb-16 px-6 md:px-16 lg:px-32 bg-gray-50">
      <div className="text-center mb-10">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800">{course.name}</h1>
